...
class StarGrid:
    ...
    def createCartesianProduct(self, cycleIndex1, cycleIndex2):
        ...
        print "WE CALCINGUITNG"
        print cycleIndex1
        i = 0
        for cStruct1 in cycleIndex1:
            i = i + 1
            k = 0
            for cStruct2 in cycleIndex2:
                print '\n---{0},{1}----'.format(i,k)
                newcycleStuct = self.computePair(cStruct1, cStruct2)
    ...
    def calculateOrbits(self, cycle_index):
        ...
        for cStruct in cycle_index:
            ...
            for cyc in cStruct.cycles:
                print "--{0},{1}---", i,k
                print "   ", cyc
                print "   power,coef", cyc.power, cStruct.coefficient
                bigNum = self.num_states ** cyc.power
                print "    power", bigNum
                bigNum = bigNum //  cStruct.coefficient
                print "    divid", bigNum
    ...
    def runLexxer(self, cycString): #Pretend it's a lexxer
        i = 0
...
if __name__ == '__main__':
    ...
    starGrid.convert_raw_cycle_index_to_objects(h)
    starGrid.convert_raw_cycle_index_to_objects(w)
    cycleIndex1 = starGrid.cycle_indecies[h] # order doesnt matter
    cycleIndex2 = starGrid.cycle_indecies[w] 
    ...
    # self.cycle_indecies[h] = 
    # self.cycle_indecies[w] = 
